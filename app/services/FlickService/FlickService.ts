...
import FlickServiceInterface from "~/services/FlickService/FlickServiceInterface";

export default class FlickService implements FlickServiceInterface {
    private flicks: FlickModelInterface[] = [
        {
            id: 1,
            genre: 'Musical',
